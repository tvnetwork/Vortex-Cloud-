  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-text-primary mb-1">Projects</h1>
          <p className="text-sm text-text-secondary">View and manage your deployments.</p>
        </div>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="bg-primary text-text-primary hover:bg-secondary hover:bg-zinc-200 font-medium px-4 py-2 rounded-md flex items-center gap-2 transition-colors text-sm whitespace-nowrap"
          >
      ...
      {loading ? (
        ...
        <div className="border border-border bg-background rounded-[var(--radius-card)] p-12 text-center flex flex-col items-center justify-center">
          ...
          <Link 
            to="/projects/new"
            className="bg-primary text-text-primary hover:bg-secondary hover:bg-zinc-200 font-medium px-4 py-2 rounded-md transition-colors flex items-center gap-2 text-sm w-fit mx-auto"
          >
          ...
          {filteredProjects.map((project) => {
            ...
            return (
              <Link
                ...
                className="bg-background border border-border hover:border-zinc-600 rounded-[var(--radius-card)] p-5 transition-colors group flex flex-col justify-between min-h-[160px]"
              >
                <div>
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-[var(--radius-pill)] bg-card border border-border flex items-center justify-center">
                  ...
                  <p className="text-sm text-muted line-clamp-1 mb-4">
                    {displayDomain}
                  </p>
                </div>
                  ...
                  <div className="flex items-center gap-2">
                    {projectServices.length > 0 ? (
                      ...
                      <span className="flex items-center gap-1.5 text-xs text-muted">
                        <span className="w-2 h-2 rounded-[var(--radius-pill)] bg-zinc-600" />
                        No Deployments
                      </span>
                    )}
                  </div>
